    ...
    <div class="album py-2 bg-light">
        <div class="py-2 container">
            ...
            <form action="${pageContext.request.contextPath}/signup" method="post">
                ...
                <div class="col-sm-6 m-2">
                    <label for="firstmane">Prénom</label>
                    <input type="text" name="firstmane" id="firstmane" class="form-control" required>
                </div>
                <div class="col-sm-6 m-2">
                ...
                <div class="col-sm-6 m-2">
                    ...
                    <button type="submit" class="btn my-2 text-white" style="background-color: darkslategray">Créer mon profil</button>
